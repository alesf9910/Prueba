...
public class PostReportController extends Controller<PostReportFacade> {
    ...
    public Mono<ResponseEntity> create(@ApiParam(name = "to", value = "Data of report to be report") @RequestBody PostReportTO to, @ApiIgnore ServerWebExchange exchange) {
    ...
    public Mono<ResponseEntity> searchPost(@ApiParam(name = "to", value = "Data of post report to be search") @RequestBody PostReportCriteriaTO to, @ApiIgnore ServerWebExchange exchange) {
        return this.get((facade, context) -> facade.search(to, context), exchange);
    }
